...
@section('content')
    <div class="container">
        <div class="panel panel-default">
            <div class="panel-heading">LocationProvince {{ $locationprovince->id }}</div>
            <div class="panel-body">
                ...
                <a href="{{ url('/backend/location-province/' . $locationprovince->id . '/edit') }}"
                ...
                {!! Form::open([
                    'method'=>'DELETE',
                    'url' => ['backend/locationprovince', $locationprovince->id],
