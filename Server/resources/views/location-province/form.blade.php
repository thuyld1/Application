...
</div><div class="form-group {{ $errors->has('simple') ? 'has-error' : ''}}">
    {!! Form::label('simple', 'Simple', ['class' => 'col-md-4 control-label']) !!}
    <div class="col-md-6">
        {!! Form::text('simple', null, ['class' => 'form-control']) !!}
        {!! $errors->first('simple', '<p class="help-block">:message</p>') !!}
    </div>
</div>
