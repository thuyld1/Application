...
public class SwipeToLoadLayout extends ViewGroup {
    ...
    protected boolean canChildScrollUp() {
        if (android.os.Build.VERSION.SDK_INT < 14) {
            if (mTargetView instanceof AbsListView) {
                ...
                return isRecyclerViewCanUp((RecyclerView) mTargetView);
            } else {
    ...
    protected boolean canChildScrollDown() {
        if (android.os.Build.VERSION.SDK_INT < 14) {
            if (mTargetView instanceof AbsListView) {
                ...
                return isRecyclerViewCanDown((RecyclerView) mTargetView);
            } else {
                return ViewCompat.canScrollVertically(mTargetView, -1) || mTargetView.getScrollY() > 0;
            }
        } else {
    ...
    private boolean isRecyclerViewCanUp(RecyclerView recyclerView) {
    ...
    private boolean isRecyclerViewCanDown(RecyclerView recyclerView) {
        LinearLayoutManager layoutManager = (LinearLayoutManager) recyclerView.getLayoutManager();
